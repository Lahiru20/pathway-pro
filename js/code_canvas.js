...
function load_table(fetch_data){
    ...
    document.getElementById('compile-clear-canvas').addEventListener('click', function () {
        codeMirror.setValue('');
    });
...
document.getElementById('confirm-button').addEventListener('click', function () {
        ...
        if(selectedQuestion.innerText == 'Select a question from the table above to solve it here..'){
